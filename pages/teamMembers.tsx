    ...
    <div key={member.name} className={memberStyles.memberCard}>
      ...
      {activeTab === 'past' ? (
        <p className={teamStyles.memberMeta}>
          {member.dateOfService ? `Service: ${member.dateOfService}` : 'Service: —'}
        </p>
      ) : (
        <p className={teamStyles.memberMeta}>
          Joined: {member.dateJoined ?? '—'}{member.dateOfService ? ` • Service: ${member.dateOfService}` : ''}
        </p>
      )}
    </div>
  );
      ...
      <main className={styles.mainContent}>
        <div className={styles.contentWrapper}>
          ...
          <div className={teamStyles.tabs}>
            <button className={`${teamStyles.tabButton} ${activeTab === 'executive' ? teamStyles.active : ''}`} onClick={() => setActiveTab('executive')}>Executive Team</button>
            <button className={`${teamStyles.tabButton} ${activeTab === 'software' ? teamStyles.active : ''}`} onClick={() => setActiveTab('software')}>Software Team</button>
            <button className={`${teamStyles.tabButton} ${activeTab === 'competitive' ? teamStyles.active : ''}`} onClick={() => setActiveTab('competitive')}>Competitive Trivia Team</button>
            <button className={`${teamStyles.tabButton} ${activeTab === 'past' ? teamStyles.active : ''}`} onClick={() => setActiveTab('past')}>Past Members</button>
          </div>
